...
export function mostrarToast(mensaje) {
    ...
    // Detectamos si es una advertencia por el emoji que ya usas
    if (mensaje.includes('⚠️')) toast.classList.add('warning');
    if (mensaje.includes('❌')) toast.classList.add('error');
