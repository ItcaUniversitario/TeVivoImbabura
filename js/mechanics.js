...
export async function cruzarTrenVisual(posAMover, jugadorId) {
    ...
    if (posAMover === 7) {
        ...
        ruta = [
            { left: '73.45%', top: '24.03%', transform: 'translate(-50%, -50%)' }, 
            { left: '74.96%', top: '26.57%', transform: 'translate(-50%, -50%)' }, 
            { left: '76.47%', top: '28.60%', transform: 'translate(-50%, -50%)' }, 
            { left: '78.50%', top: '30.63%', transform: 'translate(-50%, -50%)' }, 
            { left: '80.86%', top: '32.15%', transform: 'translate(-50%, -50%)' }  
        ];
    }
        ...
        ruta = [
            { left: '84.10%', top: '58.47%', transform: 'translate(-50%, -50%)' }, 
            { left: '81.34%', top: '57.87%', transform: 'translate(-50%, -50%)' }, 
            { left: '78.69%', top: '60.25%', transform: 'translate(-50%, -50%)' }, 
            { left: '76.27%', top: '60.84%', transform: 'translate(-50%, -50%)' }  
        ];
    }
    else if (posAMover === 27) { 
        gifUsar = 'tren_izquierda.gif';
        idTrenEstacionado = 'tren-espera-tren_fin';
        ruta = [
            { left: '53.69%', top: '55.20%', transform: 'translate(-50%, -50%)' },
            { left: '51.04%', top: '54.31%', transform: 'translate(-50%, -50%)' },
            { left: '47.70%', top: '54.60%', transform: 'translate(-50%, -50%)' },
            { left: '44.59%', top: '54.01%', transform: 'translate(-50%, -50%)' },
            { left: '41.47%', top: '54.01%', transform: 'translate(-50%, -50%)' },
            { left: '38.48%', top: '50.45%', transform: 'translate(-50%, -50%)' },
            { left: '35.71%', top: '48.07%', transform: 'translate(-50%, -50%)' },
            { left: '32.60%', top: '47.77%', transform: 'translate(-50%, -50%)' },
            { left: '29.72%', top: '47.77%', transform: 'translate(-50%, -50%)' },
            { left: '27.07%', top: '48.96%', transform: 'translate(-50%, -50%)' },
            { left: '23.96%', top: '49.26%', transform: 'translate(-50%, -50%)' }
        ];
    } else {
        return false; 
    }
    ...
    return new Promise((resolve) => {
        ...
        setTimeout(() => {
            ...
            // ¡EL ARREGLO ESTÁ AQUÍ! Ahora usa coordDestinoFicha (La casilla real)
            ...
            fichaJugador.style.transform = "translate(-50%, -50%) scale(1)"; // Mantenerla centrada
            ...
            const tiempoCalculado = ruta.length * 1500; 
