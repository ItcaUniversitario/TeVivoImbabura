...
const CASILLAS = // Contenido para el Nivel 2 (36 casillas en total)
    [
        // 0. INICIO (Solicitado)
        { tipo: 'inicio', titulo: 'Introducción a: Cima de los Ancestros ', descripcion: 'Inicias el recorrido por los tesoros de la Ruta 4.' },
...
const PREGUNTAS = [
    ...
    },
    {
        ...
        opciones: ["García Moreno", "Vacas Galindo", "Peñaherrera", "Apuela"],
        correcta: 2 // Peñaherrera
    },
    {
        id: 18,
        categoria: 'gualiman',
        pregunta: "¿Cómo se llama el principal atractivo arqueológico que destaca en la llanura de Gualimán?",
        opciones: ["Tolas ceremoniales", "Monedas de oro españolas", "Armaduras de hierro coloniales", "Fósiles de dinosaurios"],
