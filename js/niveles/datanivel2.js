...
const CASILLAS = // Contenido para el Nivel 2 (36 casillas en total)
    [
        ...
        { tipo: 'minijuego', subtipo: 'cuatro_imagenes', titulo: '👁️ Ojo de Águila', pregunta: '¿Cuál es el Volcán Cubilche?', opcionesImagenes: ['assets/lugares/nivel2/minijuego/volcan0.jpg', 'assets/lugares/nivel2/miinjuego/volcan1.jpeg', 'assets/lugares/nivel2/volcan2.jpg', 'assets/lugares/nivel2/volcan3.jpg'], indiceCorrecto: 0, recompensa: { puntos: 50 } },
        // 5. TRAMPA DE RETORNO AL INICIO 
        {
            tipo: 'evento',
            subtipo: 'trampa', // Para que salga en rojo
            titulo: '⛈️ Tormenta de Montaña',
            descripcion: 'El clima se ha vuelto peligroso y pierdes el rumbo. Por seguridad, debes regresar al campamento base.',
            text: '¡Vuelves al Inicio!',
            movimiento: -5, // Estamos en la casilla 5. 5 - 5 = 0 (Inicio)
            pointsLost: 15
        },

        // 4. LUGAR EMBLEMÁTICO (Solicitado)
        { tipo: 'lugar_emblematico', titulo: 'Termas de Chachimbiro', imagen: 'assets/lugares/nivel2/termas_chachimbiro.png', descripcion: 'Aguas medicinales de origen volcánico. Obtienes +50 puntos y ', recompensa: { puntos: 50, item: 'cristal_termal' } },



        // 
        { tipo: 'camino', titulo: 'Ruta de los Lagos', descripcion: 'Divisas el valle a lo lejos.', recompensa: null },
        { tipo: 'minijuego', subtipo: 'cuatro_imagenes', titulo: '👁️ Ojo de Águila', pregunta: '¿Cuál es el Sendero Artezón?', opcionesImagenes: ['assets/lugares/nivel2/minijuego/sendero0.jpg', 'assets/lugares/nivel2/minijuego/sendero1.jpeg', 'assets/lugares/nivel2/minijuego/sendero2.jpeg', 'assets/lugares/nivel2/minijuego/sendero3.jpg'], indiceCorrecto: 1, recompensa: { puntos: 50 } },
        { tipo: 'camino', titulo: 'Vereda de Piedra', descripcion: 'Sigue el rastro ancestral.', recompensa: null },
        { tipo: 'camino', titulo: 'Ruta de los Lagos', descripcion: 'Divisas el valle a lo lejos.', recompensa: null },
        { tipo: 'minijuego', subtipo: 'cuatro_imagenes', titulo: '👁️ Ojo de Águila', pregunta: '¿Cuál es el Sendero Artezón?', opcionesImagenes: ['assets/lugares/nivel2/sendero1.jpeg', 'assets/lugares/nivel2/sendero_artezon.jpg', 'assets/lugares/nivel2/sendero2.jpeg', 'assets/lugares/nivel2/sendero3.jpg'], indiceCorrecto: 1, recompensa: { puntos: 50 } },

        // 10. LUGAR EMBLEMÁTICO (Solicitado)
        { tipo: 'lugar_emblematico', titulo: 'Sendero El Artezón', imagen: 'assets/lugares/nivel2/minijuego/sendero_artezon.png', descripcion: 'Un camino rodeado de flora nativa única.', recompensa: { puntos: 50, item: 'baston_viajero' } },
        ...
        { tipo: 'lugar_emblematico', titulo: 'Talleres de Talabartería', imagen: 'assets/lugares/nivel2/talleres_talabarteria.png', descripcion: 'Arte en cuero de maestros artesanos.', recompensa: { puntos: 50, item: 'cuero_tradicional' } },

        //  Transición
        { tipo: 'camino', titulo: 'Barrio Obrero', descripcion: 'Escuchas el martilleo del cuero.', recompensa: null },
        { tipo: 'minijuego', subtipo: 'cuatro_imagenes', titulo: '👁️ Ojo de Águila', pregunta: '¿Cuál es la Cascada de Peguche?', opcionesImagenes: ['assets/lugares/nivel2/cascada_peguche.jpg', 'assets/lugares/nivel2/cascada1.jpeg', 'assets/lugares/nivel2/cascada2.jpg', 'assets/lugares/nivel2/cascada3.jpg'], indiceCorrecto: 0, recompensa: { puntos: 50 } },
        ...
        { tipo: 'lugar_emblematico', titulo: 'Cascada de Peguche', imagen: 'assets/lugares/nivel2/cascada_peguche.png', descripcion: 'Salto de agua ritual y sagrado.', recompensa: { puntos: 50, item: 'agua_pura' } },

        //  Tramo largo de retos
        { tipo: 'camino', titulo: 'Camino de los Incas', descripcion: 'Pisas historia pura.', recompensa: null },
        { tipo: 'minijuego', subtipo: 'cuatro_imagenes', titulo: '👁️ Ojo de Águila', pregunta: '¿Dónde está Sanshipamba?', opcionesImagenes: ['assets/lugares/nivel2/sanshipamba.jpg', 'assets/lugares/nivel2/volcan_cubilche.jpg', 'assets/lugares/nivel2/alleres.png'], indiceCorrecto: 0, recompensa: { puntos: 50 } },
        ...
        { tipo: 'lugar_emblematico', titulo: 'Volcán Cubilche', imagen: 'assets/lugares/nivel2/volcan_cubilche.png', descripcion: 'Cerro sagrado de energía renovadora.', recompensa: { puntos: 50, item: 'piedra_sagrada' } },

        //  Tramo final
        { tipo: 'camino', titulo: 'Ruta Medicinal', descripcion: 'Sientes el olor al azufre sanador.', recompensa: null },
        { tipo: 'minijuego', subtipo: 'cuatro_imagenes', titulo: '👁️ Ojo de Águila', pregunta: '¿Reconoces las Termas?', opcionesImagenes: ['assets/lugares/nivel2/sendero_artezon.jpg', 'assets/lugares/nivel2/termas_chachimbiro.jpg', 'assets/lugares/nivel2/volcan_cubilche.jpg'], indiceCorrecto: 1, recompensa: { puntos: 50 } },
        ...
        { tipo: 'lugar_emblematico', titulo: 'Bosque Sanshipamba', imagen: 'assets/lugares/nivel2/sanshipamba_pimampiro.png', descripcion: 'Pulmón biodiverso de Pimampiro.', recompensa: { puntos: 0, item: 'semilla_nativa' } },
