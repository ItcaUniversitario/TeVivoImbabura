...
const CASILLAS = [
    // CASILLA 8
    {
        ...
        descripcion: 'Prepárense para la aventura.',
    ...
    // CASILLA 26
    {
        ...
        pregunta: '¿Cómo se llama el domo interior de mayor tamaño que emerge en el centro de la Laguna de Cuicocha?',
        opciones: ['Yahuarcocha', 'Cuicocha', 'Teodoro Wolf'],
        respuestaCorrecta: 2,
        recompensa: {
            correcta: {
...
const PREGUNTAS = [
    ...
    {
        id: 6,
        pregunta: "¿En qué parroquia rural del cantón Ibarra se encuentra ubicado el mirador Mucha Naju Rumi?",
        opciones: ['Angochagua', 'San Antonio', 'La Esperanza', 'Salinas'],
        correcta: 0 // Angochagua
    },
    {
        id: 7,
        pregunta: "¿Cuál es el significado al español del nombre kichwa 'Mucha Naju Rumi'?",
    ...
    {
        id: 8,
        pregunta: "¿En qué idioma está nombrado el atractivo turístico conocido como Mucha Naju Rumi?",
        opciones: ['Español', 'Awa Pit', 'Kichwa', 'Shuar Chicham'],
        correcta: 2 // Kichwa
    },
    {
        id: 9,
        pregunta: "¿Qué tipo de formación geográfica es el Mucha Naju Rumi en la zona de Angochagua?",
        opciones: ['Una laguna volcánica', 'Un mirador natural', 'Una cascada escondida', 'Un valle profundo'],
        correcta: 1 // Un mirador natural
    },
    {
        id: 10,
        pregunta: "¿Qué importante geositio de Imbabura es conocido tradicionalmente como el 'Lugar donde se besan las rocas'?",
        opciones: ['Mucha Naju Rumi', 'Cascada de Peguche', 'Lechero de Otavalo', 'Arbolito de Ibarra'],
    ...
    {
        id: 16, 
        pregunta: "¿Cómo se llama exactamente el primer tramo de 300 metros del famoso sendero que rodea la Laguna de Cuicocha?",
